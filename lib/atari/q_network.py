...
class QNetwork():
    ...
    def __init__(self, args, num_actions, path):
        ...
        self.sess.run(tf.initialize_all_variables())
        print("Network Initialized")
        self.summary_writer = tf.train.SummaryWriter(self.path + '/params', self.sess.graph)
    ...
    def save_model(self, epoch):
        ...
        self.saver.save(self.sess, self.path + '/checkpoints/' + self.name + '.ckpt', global_step=epoch)
